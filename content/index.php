...
<body>
		...
		<main>
			...
			<ul class="box-info">
				...
				<li>
					...
					<label for="btn-modal2" class="lbl-modal2">
						<i class='bx bxs-thermometer'></i>
					</label>
					<div class="modal2">
						<div class="contenedor2">
							<header class="CHT2">Control de Temperatura y Humedad</header>
							<label for="btn-modal2">X</label>
							<div class="contenido2">
								<iframe src="HumedadTemperatura/index.php" frameborder="0" class="iframe2"></iframe>
							</div>
						</div>
					</div>	
					<span class="text1">
				...
				<li>
					...
					<label for="btn-modal1" class="lbl-modal1">
						<i class='bx bx-podcast'></i>
					</label>
					<div class="modal1">
						<div class="contenedor1">
							<header class="CI1">Control de Iluminacion</header>
							<label for="btn-modal1">X</label>
							<div class="contenido1">
								<iframe src="SistemaIluminacion/index.php" frameborder="0" class="iframe1"></iframe>
							</div>
						</div>
					</div>	
					<span class="text1">
	...
	<!-- CONTENT -->
	<div class="mapouter">
		<div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=umbita&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-org.net"></a><br>
			<style>
				.mapouter {
					position: relative;
					text-align: right;
			...
			</style><a href="https://www.embedgooglemap.net">google map iframe generator</a>
			<style>
				.gmap_canvas {
					overflow: hidden;
